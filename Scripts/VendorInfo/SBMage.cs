...
namespace Server.Mobiles
{
    public class SBMage : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            ...
            {
                Add(new GenericBuyInfo(typeof(Spellbook), 18, 20, 0xEFA, 0));
				Add(new GenericBuyInfo(typeof(NecromancerSpellbook), 115, 20, 0x2253, 0));
				
                Add(new GenericBuyInfo(typeof(ScribesPen), 8, 999, 0xFBF, 0));
				...
				Add(new GenericBuyInfo(typeof(Runebook), 25, 20, 0x22C5, 0));
                ...
                Add(new GenericBuyInfo(typeof(LesserPoisonPotion), 15, 20, 0xF0A, 0, true));
                Add(new GenericBuyInfo(typeof(LesserCurePotion), 15, 20, 0xF07, 0, true));
                Add(new GenericBuyInfo(typeof(LesserExplosionPotion), 21, 20, 0xF0D, 0, true));
				*/
